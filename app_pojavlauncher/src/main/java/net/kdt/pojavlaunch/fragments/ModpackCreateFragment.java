...
public class ModpackCreateFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.button_browse_modpacks).setOnClickListener(v -> {
            tryInstall(SearchModFragment.class, SearchModFragment.TAG, SearchModFragment.createArguments(SearchFilters.TYPE_MODPACK));
        });
    ...
    private void tryInstall(Class<? extends Fragment> fragmentClass, String tag, @Nullable Bundle bundle){
        Tools.swapFragment(requireActivity(), fragmentClass, tag, bundle);
    }
}
