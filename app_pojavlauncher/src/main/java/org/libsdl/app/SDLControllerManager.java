...
public class SDLControllerManager
{
    ...
    public static void setDirectGamepadEnableHandler(DirectGamepadEnableHandler handler) {
        SDLJoystickHandler.sDirectGamepadEnableHandler = handler;
    }
...
class SDLJoystickHandler {
    ...
    static DirectGamepadEnableHandler sDirectGamepadEnableHandler;
    private static boolean firstPollDone;
    ...
    synchronized void pollInputDevices() {
        if (!firstPollDone) {
            ...
            firstPollDone = true;
            Log.i("SDL", "SDL detected; direct gamepad support enabled");
        }
